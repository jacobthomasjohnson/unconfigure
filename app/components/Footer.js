      ...
      return (
            <footer className="w-full bg-neutral-900 py-4 pb-6">
                  <div className="max-w-md mx-auto flex flex-col gap-2">
                        ...
                        {showToggle && (
                              <button
                                    className="w-full border border-[#505050] rounded-md p-4 text-xs hover:bg-neutral-100 dark:hover:bg-neutral-700"
                                    onClick={() =>
                                          setViewMode((m) => (m === 'guess' ? 'correct' : 'guess'))
                                    }
                              >
                                    {viewMode === 'guess' ? <div className="flex gap-2 justify-center">View Correct Answers <span>⇆</span></div> : <div className="flex gap-2 justify-center">View Your Guess<span>⇆</span></div>}
                              </button>
                        )}
                        ...
                        {gameOver && submittedGuesses.length > 0 && (
                              <div className="flex flex-col items-center gap-2">
                                    ...
                                    <button
                                          onClick={handleCopy}
                                          className="border flex justify-center gap-2 rounded-md p-4 w-full text-xs text-purple-300 hover:bg-green-50 dark:hover:bg-neutral-700"
                                    >
                                          {!copied && (
